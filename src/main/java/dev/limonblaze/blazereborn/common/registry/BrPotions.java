...
public class BrPotions {
    ...
    public static final RegistryObject<Potion> LONG_SOUL_PIERCING = POTION.register("long_soul_piercing", () -> new Potion("soul_piercing", new MobEffectInstance(BrEffects.SOUL_PIERCING.get(), 9600)));
    public static final RegistryObject<Potion> STRONG_SOUL_PIERCING = POTION.register("strong_soul_piercing", () -> new Potion("soul_piercing", new MobEffectInstance(BrEffects.SOUL_PIERCING.get(), 1800, 1)));
    public static final RegistryObject<Potion> SOUL_PIERCING = POTION.register("soul_piercing", () -> new Potion(new MobEffectInstance(BrEffects.SOUL_PIERCING.get(), 3600)));
